...
export function ScreenshotScene() {
  ...
  return (
    <section id="experience" className="relative py-32">
      <div className="mx-auto w-full max-w-[1480px] px-6 sm:px-10 lg:px-14 xl:px-16">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6">
          <div className="min-w-0">
            ...
            <motion.h2
              className="flex w-fit flex-col gap-3 font-[family-name:var(--font-display)] text-[clamp(3rem,6.5vw,5.75rem)] font-extrabold tracking-[0.02em] sm:gap-4"
